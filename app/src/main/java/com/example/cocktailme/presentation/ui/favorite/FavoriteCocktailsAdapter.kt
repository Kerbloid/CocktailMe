...
import com.example.cocktailme.presentation.ui.home.CocktailsAdapter

class FavoriteCocktailsAdapter(private val listener: CocktailClickListener) :
    ListAdapter<CocktailItem, FavoriteCocktailsAdapter.CocktailViewHolder>(CocktailsDiffCallback()) {
